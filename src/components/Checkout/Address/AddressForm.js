                        ...
                        <FormProvider {...methods}>
                            <form
                                ...
                                <Grid container spacing={1}>
                                    ...
                                    <FormInput required name="firstName" label="Förnamn" />
                                        <FormInput required name="lastName" label="Efternamn" />
                                        <FormInput required name="address1" label="Address" />
                                        <FormInput required name="email" label="Email" />
                                        <FormInput required name="city" label="Stad" />
                                        <FormInput required name="zip" label="Zip / Postort" />
                                 
                                 
                                
                                    <Grid item xs = {14} sm={6}>
                                            <InputLabel>Fraktland</InputLabel>
                                    ...
                                    <InputLabel>Stad/Län</InputLabel>
                                    ...
                                    <Grid item xs = {12} sm={6}>
                                    <InputLabel>Fraktkostnad</InputLabel>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 20 }}>
                                        <Button component={Link} variant="outlined" to="/cart">Varukorgen</Button>
